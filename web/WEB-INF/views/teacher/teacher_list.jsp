	    ...
	    $('#dataList').datagrid({ 
	        ...
	        columns: [[  
				{field:'chk',checkbox: true,width:50},
 		        ...
 		        {field:'username',title:'工号',width:150, sortable: true},
   		...
   		<form id="addForm" method="post">
	    	<table id="addTable" cellpadding="8">
	    		<tr >
	    			<td>工号:</td>
	    			<td>
	    				<input id="add_username"  class="easyui-textbox" style="width: 200px; height: 30px;" type="text" name="username" data-options="required:true, missingMessage:'请填写工号'"  />
	    			</td>
	    		</tr>
				<tr >
					<td>姓名:</td>
					<td>
						<input id="add_tname"  class="easyui-textbox" style="width: 200px; height: 30px;" type="text" name="tname" data-options="required:true, missingMessage:'请填写姓名'"  />
					</td>
				</tr>
	    		<tr>
	    			<td>密码:</td>
    	...
    	<form id="editForm" method="post">
	    	...
	    	<table id="editTable" border=0 cellpadding="8" >
	    		<tr >
	    			<td>工号:</td>
	    			<td>
	    				<input id="edit_username"  class="easyui-textbox" style="width: 200px; height: 30px;" type="text" name="username" data-options="required:true, missingMessage:'请填写工号'"  />
	    			</td>
	    		</tr>
				<tr >
					<td>姓名:</td>
					<td>
						<input id="edit_tname"  class="easyui-textbox" style="width: 200px; height: 30px;" type="text" name="tname" data-options="required:true, missingMessage:'请填写姓名'"  />
					</td>
				</tr>
	    		<tr>
	    			<td>密码:</td>
